// ======================================================
// INTERVIEW PREP — Culture & Leadership
...
export const GL_ATTRIBUTES = [
  ...
  { name: 'Culture fit', means: 'Comfort with ambiguity, bias to action, intellectual humility, collaboration' },
];
...
export const STORY_SEEDS: StorySeed[] = [
  ...
  { id: 'feedback', title: 'Difficult feedback', drawFrom: 'A code review that stung and was right', attribute: 'Culture fit', answers: [GL_QUESTIONS[2]] },
  ...
  { id: 'why-google', title: 'Why this company', drawFrom: 'Specific: scale, a specific product, a specific team. Not "great culture."', attribute: 'Motivation', answers: [GL_QUESTIONS[10]] },
];
...
export const STAR_RULES = [
  ...
  'Never blame anyone. Even when they deserved it — this is a direct culture-fit probe.',
