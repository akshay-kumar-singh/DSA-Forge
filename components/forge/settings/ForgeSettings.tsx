      ...
      {show && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <motion.div
            ...
            className="w-full max-w-md bg-bg-surface border border-border-default rounded-lg shadow-2xl overflow-hidden"
          >
            {/* Header */}
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <select
                    ...
                    className="h-9 px-3 text-[11px] font-bold uppercase bg-bg-base border border-border-default text-text-secondary rounded outline-none cursor-pointer hover:border-blue-500/40 transition-colors"
                  >
                    {AI_PROVIDERS.map(p => (
                  ...
                  <select
                    ...
                    className="h-9 px-3 text-[11px] bg-bg-base border border-border-default text-text-secondary rounded outline-none cursor-pointer hover:border-blue-500/40 transition-colors truncate"
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <select
                    ...
                    className="h-9 px-3 text-[11px] bg-bg-base border border-border-default text-text-secondary rounded outline-none cursor-pointer hover:border-blue-500/40 transition-colors"
                  >
                    {FONT_OPTIONS.map(f => (
              ...
              {/* Forge Mode info */}
              <div className="p-3 rounded bg-blue-500/5 border border-border-subtle space-y-1">
